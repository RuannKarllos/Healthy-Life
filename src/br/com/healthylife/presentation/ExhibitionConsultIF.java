...
import br.com.healthylife.structures.Fila;
 ...
 * @author ruann
 */
public class ExhibitionConsultIF extends javax.swing.JInternalFrame {

    /**
     * Creates new form ExhibitionConsultIF
     */
    public ExhibitionConsultIF() {
        initComponents();
    ...
    private void setList() {
        ...
        try {
            File file = new File("Consultation");
            File fileList[] = file.listFiles();

            IDao<Consultation> dc = Factory.getDao(Consultation.class);
            
            Fila f = new Fila(fileList.length);
